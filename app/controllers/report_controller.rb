	...
	def get_report
		...
		if level == "national"
			if department == "all"
				...
				quaters[selected_quater].each do |month|				
						period = year + "-" + month
					...
					res = TestType.where(name: "TB Microscopic Exam").first
						...
						indicator_data_serology['Syphilis screening on patients (by department)'] =  keeper[32]
				...
				if department == "Haematology"
					...
					quaters[selected_quater].each do |month|				
						...
						indicator_data['Syphilis screening on patients (by department)'] =  keeper[0]
			...
			if department == "all"
				...
				quaters[selected_quater].each do |month|				
						...
						indicator_data_serology['Syphilis screening on patients (by department)'] =  keeper[26]
